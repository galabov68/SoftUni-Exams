...
public class ImportController extends BaseController {
    ...
    public ModelAndView importRaceEntries() throws IOException, JAXBException {
    ...
    @GetMapping("/races")
    public ModelAndView importRaces() throws IOException, JAXBException {
        return super.view("xml/import-races", "races", this.raceService.readRacesXmlFile());
    }

    @PostMapping("/races")
    public ModelAndView importRacesConfirm() throws JAXBException, IOException {
